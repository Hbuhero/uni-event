    ...
    <div class="flex flex-col items-center !mt-20 !mb-20" >
        ...
        <div class=" mb-15 grid grid-cols-4 gap-4">
            <div class="border rounded-lg w-[18rem]  flex flex-col items-center pt-5 pb-4 pr-20 pl-20">
                ...
                <div class="flex flex-col mt-5 items-center">
                    <span class="font-medium text-medium">Art & Culture</span>
                    <span class="text-xs ">1 Events</span>
                </div>
            </div>
        ...
        <div class="bg-blue-100 ">
            <div class=" flex flex-col items-center w-[30vw] mt-10 mb-10 !p-12">
                ...
                <button class="border  rounded-lg !py-2 !bg-blue-700 text-white !px-5">
                    <span class="text-sm tracking-widest font-medium">Create an Event</span>
                </button>
            </div>
        </div>
