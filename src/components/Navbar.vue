<template>
    <div class="flex justify-between mt-[10px] p-[10px] items-center border-2">
        ...
        <div class="tracking-wider">
            <a href="#"><span class="mr-4 text-sm font-medium">Home</span></a>
            <a href="#"><span class="mr-4 text-sm font-medium">Events</span></a>
            <a href="#"><span class="mr-4 text-sm font-medium">Categories</span></a>
            <a href="#"><span class="mr-4 text-sm font-medium">Log in</span></a>
        </div>
    </div>
</template>
