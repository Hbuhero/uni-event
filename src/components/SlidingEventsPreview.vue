    ...
    <div class="w-screen  border-2 bg-[url(../assets/img/unievent-high-resolution-logo.png)] bg-cover ">
        <div class=" mb-16 flex flex-col w-[50vw] gap-12 border mt-16 pb-7 pl-5 pr-5 pt-5 relative place-self-center">
            <article class="mt-10">
                ...
                <div class="flex ">
                    <div class="mr-5 pr-2 pt-2 pb-2 pl-2 rounded-lg border">View Details</div>
                    <div class="pr-2 pt-2 pb-2 pl-2 rounded-lg border">Register Now (299)</div>
                </div>

                <div class="absolute top-0 rounded-full border mt-2 pl-3 pr-3   ">
